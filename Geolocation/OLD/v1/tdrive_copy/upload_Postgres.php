...
foreach($container as &$item){
	...
	$Psql .= "('".$splitter[0]."','".$splitter[1]."','".$splitter[2]."','".$splitter[3]."','".$splitter[4]."','".$splitter[5]."',".$splitter[6].",".$splitter[7].",".$splitter[8].",".$splitter[9].",".$splitter[10].",".$splitter[11].",".$splitter[12].",'".$splitter[13]."','".$splitter[14]."',ST_SetSRID(ST_GeomFromGeoJSON('{\"type\":\"Point\",\"coordinates\":".$splitter[15]."}'), 4326)),";
	}
	else{
			$Ltrigger = 1;
			if($splitter[25]=="NULL"){
